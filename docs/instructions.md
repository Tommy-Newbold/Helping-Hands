...
See `docs/shopping_list.md`
Print the enclosure and internal parts  
See the MakerWorld model page and `docs/3d_printing.md`
Cast the hand  
Choose either a plaster hand or a polyurethane cold cast hand.
Wire the electronics
Flash the ESP32 with MicroPython  
See the official MicroPython ESP32 getting started guide
Upload the Helping Hands firmware
Add your audio files to the JQ6500 module
Test touch, audio, lights, and power
Install the hand
---
Before you begin
...
Useful links
MicroPython ESP32 getting started guide
`mpremote` on PyPI
Thonny Python IDE
Instructables: Lifecasting Hands
Smooth-On: Moulding a 3D object with Rebound 25
---
<details>
...
Strip around 80% of the wire that will sit inside the plaster
Leave a small amount of sheathing inside the plaster so the wire is mechanically held
Leave around 100mm of wire hanging out from the base of the hand
...
Carefully remove the hand from the alginate mould
Leave the plaster hand to fully dry and cure for at least 48 hours
Sand, paint, or finish the hand if desired
...
Take your dried plaster hand
Hot glue it to a board you do not care about
Use a brush-on silicone such as Smooth-On Rebound 25
Build up the mould in layers, following Smooth-On’s instructions
Allow the mould to fully cure
Useful reference:
Smooth-On: Moulding a 3D object with Rebound 25
...
Pour the first resin/metal mix into the mould
Rotate the mould constantly so the resin coats every surface
Keep rotating for around 5 minutes, or until the resin starts to set and no longer drips
Repeat immediately with another batch
Build up 3–4 coats until you have a strong hollow hand
Add wires and mounting rods
Once the hollow hand has been formed:
Insert the touch sensing wires into the fingers
Insert the M5 threaded rods using the alignment tool
Fix everything in place with a final batch of resin
You do not need to add metal powder to this final internal fixing pour.
Finish the cold cast hand
Once cured:
Demould carefully
Trim or sand any rough edges
Polish the surface with a metal polish such as Autosol, if desired
...
Lay copper tape over all the printed traces
Gently press the tape into the trace channels  
A cotton bud tip works well
Sand away the extra copper tape using 400 grit sandpaper or an orbital sander
Keep sanding until only the intended copper traces remain
Check carefully for shorts between traces
...
---
4.2 Add header pins
Place PTH header pins into the board from the non-tape side
Solder each joint onto the copper tape
Heat the pin, not the tape
Let the solder flow onto the copper
> [!CAUTION]  
...
---
7.1 Power on
Turn the key switch to power on the hand
Wait around 10 seconds for the touch sensor to calibrate
Do not touch the hand during calibration
---
...
Connect to the hand’s Wi-Fi network  
